 ...
 */
#ifndef _ICM20948_SYSTEM_H_
#define _ICM20948_SYSTEM_H_
...
/*
 * Select communication between  and INV device by setting 0/1 to one of the following defines
 */
